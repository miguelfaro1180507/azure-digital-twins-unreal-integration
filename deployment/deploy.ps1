...
function New-Deployment() {
    ...
    $adx_locations = Get-ResourceProviderLocations -provider 'Microsoft.Kusto' -typeName 'clusters'
    $locations = $adt_locations | Where-Object { $adx_locations -contains $_ } | Sort-Object
